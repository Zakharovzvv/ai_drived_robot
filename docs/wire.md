...
- Частота мастера **100 кГц** (авто‑fallback **50 кГц** через CLI `I2C FREQ`), подтяжки **4.7–10 кОм к 3.3V** (не к 5V!).  
...
|--------------------------|-----------|-------------|-----------------------------------------------|
| I²C SDA                  | GPIO21    | bidir       | ↔ UNO A4 (SDA), общая подтяжка 4.7–10 кОм к 3.3V |
| I²C SCL                  | GPIO14    | bidir       | ↔ UNO A5 (SCL), общая подтяжка 4.7–10 кОм к 3.3V |
